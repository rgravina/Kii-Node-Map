...
var worldMap = {
  ...
  showSearchForm: function() {
    ...
    addInput("lat", "Latitude", "60")
    addInput("lon", "Longitute", "140")
    currentPosition++;
    blessed.text({
      parent: worldMap.form,
      content: "SW:",
  ...
  draw_latlon_box: function(lat1, lon1, lat2, lon2) {
    //nw
    worldMap.map.addMarker({lat: lat1, lon: lon1, color: 'white', char: '+'});
    //se
    worldMap.map.addMarker({lat: lat2, lon: lon2, color: 'red', char: '+'});
  }
}
